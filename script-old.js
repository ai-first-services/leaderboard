...
function filterCompanies() {
    ...
    const selectedFeatured = document.getElementById('featuredFilter')?.value || '';
    ...
    filteredCompanies = companies.filter(company => {
        ...
        const featuredMatch = !selectedFeatured || (selectedFeatured === 'featured' ? company.featured : !company.featured);
        
        return regionMatch && verticalMatch && typeMatch && timeMatch && featuredMatch;
    });
...
function updateStats() {
    ...
    const totalVerticals = [...new Set(companies.map(c => c.vertical))].length;
